...
CCIS2Representation::~CCIS2Representation()
{}

/*virtual*/ OwlModel CCIS2Representation::getModel() const /*override*/
{
...
/*virtual*/ int64_t CCIS2Representation::calculateInstance(int64_t* piVertexBufferSize, int64_t* piIndexBufferSize) /*override*/
{
...
void CCIS2Representation::CalculateMinMax(
...
void CCIS2Representation::Scale(float fScaleFactor)
{
	_geometry::scale(fScaleFactor);
}

void CCIS2Representation::Calculate()
{
	// Format
	...
	for (int64_t iConceptualFaceIndex = 0; iConceptualFaceIndex < m_iConceptualFacesCount; iConceptualFaceIndex++)
	{
		...
		uint32_t iAmbientColor = CCIS2Model::DEFAULT_COLOR;
		uint32_t iDiffuseColor = CCIS2Model::DEFAULT_COLOR;
		uint32_t iEmissiveColor = CCIS2Model::DEFAULT_COLOR;
		uint32_t iSpecularColor = CCIS2Model::DEFAULT_COLOR;
