...
// ------------------------------------------------------------------------------------------------
void CDesignTreeView::LoadModel(CModel* pModel)
{
	if (pModel == nullptr)
	{
		ASSERT(FALSE);
...
// ----------------------------------------------------------------------------
void CDesignTreeView::OnNMRClickTree(NMHDR* /*pNMHDR*/, LRESULT* pResult)
{
	*pResult = 1;
...
// ----------------------------------------------------------------------------
void CDesignTreeView::OnTVNItemexpandingTree(NMHDR* /*pNMHDR*/, LRESULT* pResult)
{
	*pResult = 0;
}
...
BEGIN_MESSAGE_MAP(CDesignTreeView, CDockablePane)
	...
	ON_WM_PAINT()
	ON_WM_SETFOCUS()
	ON_NOTIFY(NM_CLICK, IDC_TREE_IFC, &CDesignTreeView::OnNMClickTree)
	ON_NOTIFY(NM_RCLICK, IDC_TREE_IFC, &CDesignTreeView::OnNMRClickTree)
	ON_NOTIFY(TVN_ITEMEXPANDING, IDC_TREE_IFC, &CDesignTreeView::OnTVNItemexpandingTree)
	ON_WM_DESTROY()
	ON_WM_SHOWWINDOW()
END_MESSAGE_MAP()
