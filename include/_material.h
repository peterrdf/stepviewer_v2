...
public: // Methods
	...
	_material()
	{
		init(0, 0, 0, 0, 0.f, nullptr, false);
	}
	...
	_material(
		...
		bool bFlipY)
	{
		init(iAmbientColor, iDiffuseColor, iEmissiveColor, iSpecularColor, fTransparency, szTexture, bFlipY);
	}
	...
	bool getFlipY() const { return m_bFlipY; }
};
