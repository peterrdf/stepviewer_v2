...
// ************************************************************************************************
_ifc_property::_ifc_property(SdaiInstance sdaiInstance, const wstring& strName, const wstring& strValue, const wstring& strUnit)
...
void _ifc_property_provider::loadPropertySet(SdaiInstance sdaiPropertySetInstance, _ifc_property_set_collection* pPropertySetCollection)
{
	...
	*/
	...
	for (SdaiInteger iMember = 0; iMember < iMembersCount; iMember++) {
		...
		auto pProperty = new _ifc_property(sdaiAggrInstance, strItem, strValue, L"");
...
void _ifc_property_provider::loadIFCQuantityLength(SdaiInstance sdaiQuantityInstance, _ifc_property_set* pPropertySet)
{
	...
	pPropertySet->properties().push_back(new _ifc_property(sdaiQuantityInstance, std::get<0>(tpProperty), std::get<1>(tpProperty), std::get<2>(tpProperty)));
}
